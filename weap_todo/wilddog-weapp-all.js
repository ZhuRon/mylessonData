    ...
    ns.wrapper = function (goog, wd) {
            ...
            if (null == b) c.push("null");
                ...
                if ("object" == typeof b) {
                    if (ea(b)) {
                        ...
                        b = d.length;
                        c.push("[");
                        for (var e = "", f = 0; f < b; f++) c.push(e), e = d[f], ya(a, a.Cd ? a.Cd.call(d, String(f), e) : e, c), e = ",";
                        c.push("]");
                        return
                    }
                    if (b instanceof String || b instanceof Number || b instanceof Boolean) b = b.valueOf();
                        ...
                        c.push("{");
                        f = "";
                        for (d in b) Object.prototype.hasOwnProperty.call(b, d) && (e = b[d], "function" != typeof e && (c.push(f), za(d, c), c.push(":"), ya(a, a.Cd ? a.Cd.call(b, d, e) : e, c), f = ","));
                        c.push("}");
                        return
                    }
                }
        ...
        Da.prototype.open = function (a, b, c) {
            ...
            a = {
                ...
                fail: function (a) {
                    500 <= a.Ae && 600 > a.Ae ? c(oa("SERVER_ERROR")) : c(oa("NETWORK_ERROR"));
                    c = null
                }
            };
            a.data = b;
        ...
        h = Ta.prototype;
        h.set = function (a, b) {
            null == b ? wx.removeStorageSync(this.zd(a)) : wx.setStorageSync(this.zd(a), b)
        };
        h.get = function (a) {
            var b;
            try {
                b = wx.getStorageSync(this.zd(a))
            } catch (c) {}
        ...
        h.remove = function (a) {
            wx.removeStorageSync(this.zd(a))
        };
        h.toString = function () {
            return "wx-storage:{}"
        };
        ...
        Wa.prototype.lf = function (a) {
            ...
            a.prototype.bindAsArray = function (a, e) {
                function d() {
                    var b = {};
                    b[e] = g;
                    a.setData(b)
                ...
                for (var g = [], k = {
                    ...
                    }, l = ["child_added", "child_removed", "child_moved", "child_changed"], m = 0; m < l.length; m++) this.on(l[m], k[l[m]]);
                a[".bindWilddogFuncs"][e] = k
            };
            a.prototype.bindAsObject = function (a, b) {
                if (null == a) throw Error("please provide page as 1st param");
        ...
        function $a() {
            ...
            this.xd = [];
            this.xd[0] = 128;
            for (var a = 1; a < this.hb; ++a) this.xd[a] = 0;
            this.Nd = this.$b = 0;
            this.reset()
        }
        la($a, Za);
        ...
        $a.prototype.update = function (a, b) {
            if (null != a) {
                p(b) || (b = a.length);
                for (var c = b - this.hb, d = 0, e = this.Vd, f = this.$b; d < b;) {
                    if (0 == f)
                        for (; d <= c;) ab(this, a, d), d += this.hb;
                    if (q(a))
                        for (; d < b;) {
        ...
        $a.prototype.digest = function () {
            var a = [],
                b = 8 * this.Nd;
            56 > this.$b ? this.update(this.xd, 56 - this.$b) : this.update(this.xd, this.hb - (this.$b - 56));
            for (var c = this.hb - 1; 56 <= c; c--) this.Vd[c] = b & 255, b /= 256;
            ab(this, this.Vd);
            for (c = b = 0; 5 > c; c++)
        ...
        var cb = Array.prototype.indexOf ? function (a, b, c) {
            ...
            fb = Array.prototype.reduce ? function (a, b, c, d) {
                d && (b = r(b, d));
        ...
        function Gb() {
            if (!Cb) {
                Cb = {};
                Db = {};
                for (var a = 0; 65 > a; a++) Cb[a] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a), Db[Cb[a]] = a, 62 <= a && (Db["ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.".charAt(a)] = a)
            }
        };
        var Hb = function () {
            var a = 1;
        ...
        function Ib(a) {
            return Error("Wilddog (" + Wilddog.De + ") INTERNAL ASSERT FAILED: " + a)
        }

        function Jb(a) {
            try {
                return "NODE" == CLIENT_TYPE ? (new Buffer(a, "base64")).toString("utf8") : "undefined" !== typeof atob ? atob(a) : Eb(a)
            } catch (b) {
        ...
        function Lb(a) {
            for (var b = "", c = 0; c < arguments.length; c++) var d = arguments[c],
                e = da(d),
                b = "array" == e || "object" == e && "number" == typeof d.length ? b + Lb.apply(null, arguments[c]) : "object" === typeof arguments[c] ? b + u(arguments[c]) : b + arguments[c],
                b = b + " ";
            return b
        }
        var Mb = null,
        ...
        function Ra(a) {
            !0 === Nb && (Nb = !1, null === Mb && !0 === v.get("logging_enabled") && Wilddog.Me(!0));
            if (Mb) {
        ...
        function Pb(a) {
            if ("undefined" !== typeof console) {
                var b = "WILDDOG INTERNAL ERROR: " + Lb.apply(null, arguments);
        ...
        function y(a) {
            if ("undefined" !== typeof console) {
                var b = "WILDDOG WARNING: " + Lb.apply(null, arguments);
        ...
        function Ub(a) {
            ...
            b.sort();
            c = "{";
            for (var d = 0; d < b.length; d++) 0 !== d && (c += ","), c += u(b[d]), c += ":", c += Ub(a[b[d]]);
            return c + "}"
        }
        ...
        function Tb(a) {
            return Xb.test(a) && (a = Number(a), -2147483648 <= a && 2147483647 >= a) ? a : null
        }
        ...
        Zb.prototype.Ab = function (a, b, c) {
            ...
            (a = this.fe(a)) && b.apply(c, a)
        };
        Zb.prototype.fc = function (a, b, c) {
            $b(this, a);
            a = this.Ec[a] || [];
        ...
        function $b(a, b) {
            x(hb(a.Ef, function (a) {
                return a === b
            }), "Unknown event: " + b)
        };

        function A(a, b) {
            Zb.call(this, ["authStateChanged", "authTokenExpired"]);
            this.Df = {
                sf: !1
            };
            this.Ee = {};
        ...
        A.prototype.emit = A.prototype.Qf;
        A.prototype.bind = function (a, b) {
            this.Ab(a, b)
        };
        A.prototype.bind = A.prototype.bind;
        A.prototype.Lg = function (a, b) {
            this.fc(a, b)
        };
        A.prototype.unbind = A.prototype.Lg;
        A.prototype.fe = function (a) {
            switch (a) {
                case bc.gb:
                    return [this.Ee[bc.gb]]
            }
            return null
        };
        var bc = {
        ...
        dc.prototype.get = function () {
            var a;
            0 < this.td ? (this.td--, a = this.hd, this.hd = a.next, a.next = null) : a = this.Of();
            return a
        };
        dc.prototype.put = function (a) {
            this.rg(a);
            this.td < this.ea && (this.td++, a.next = this.hd, this.hd = a)
        };

        function ec() {
            this.Rd = this.pc = null
        }
        var gc = new dc(function () {
            return new fc
        }, function (a) {
            a.reset()
        }, 100);
        ec.prototype.add = function (a, b) {
            var c = gc.get();
            c.set(a, b);
            this.Rd ? this.Rd.next = c : this.pc = c;
            this.Rd = c
        };
        ec.prototype.remove = function () {
            var a = null;
            this.pc && (a = this.pc, this.pc = this.pc.next, this.pc || (this.Rd = null), a.next = null);
            return a
        };
        ...
        function jc() {
            ...
            "undefined" === typeof a && "undefined" !== typeof window && window.postMessage && window.addEventListener && -1 == mb.indexOf("Presto") && (a = function () {
            ...
            if ("undefined" !== typeof a && -1 == mb.indexOf("Trident") && -1 == mb.indexOf("MSIE")) {
                var b = new a,
                    c = {},
                    d = c;
        ...
        function mc() {
            ...
            if (-1 != String(a).indexOf("[native code]")) {
                ...
                var a = pc,
                    b;
                !(b = !ga(n.setImmediate)) && (b = n.Window && n.Window.prototype) && (b = -1 == mb.indexOf("Edge") && n.Window.prototype.setImmediate == n.setImmediate);
                b ? (ic || (ic = jc()), ic(a)) : n.setImmediate(a)
            }
        }
        var nc = !1,
            oc = new ec;
        ...
        qc.prototype.then = function (a, b, c) {
            return zc(this, ga(a) ? a : null, ga(b) ? b : null, c)
        };
        qc.prototype.then = qc.prototype.then;
        qc.prototype.$goog_Thenable = !0;
        h = qc.prototype;
        h.Kg = function (a, b) {
            return zc(this, null, a, b)
        };
        h.cancel = function (a) {
            this.Z == rc && kc(function () {
                var b = new uc(a);
                Ac(this, b)
            }, this)
        };
            ...
            if (a.Z == rc)
                if (a.Ba) {
                    ...
                    if (c.ib) {
                        ...
                        e && (c.Z == rc && 1 == d ? Ac(c, b) : (f ? (d = f, d.next == c.Ob && (c.Ob = d), d.next = d.next.next) : Bc(c), Cc(c, e, vc, b)))
                    }
                    a.Ba = null
                } else sc(a, vc, b)
        }
        ...
        function sc(a, b, c) {
            if (a.Z == rc) {
                a === c && (b = vc, c = new TypeError("Promise cannot resolve to itself"));
                a.Z = 1;
                var d;
                a: {
                    var e = c,
                        f = a.Mg,
                        g = a.Ng;
                    if (e instanceof qc) Dc(e, yc(f || aa, g || null, a)),
                    d = !0;
                    else {
                        var k;
                        if (e) try {
                ...
                d || (a.qf = c, a.Z = b, a.Ba = null, Ec(a), b != vc || c instanceof uc || Gc(a, c))
            }
        }
        ...
        h.Tf = function () {
            for (var a; a = Bc(this);) Cc(this, a, this.Z, this.qf);
            this.$d = !1
        };

        function Cc(a, b, c, d) {
            if (c == vc && b.gc && !b.Uc)
                for (; a && a.ed; a = a.Ba) a.ed = !1;
            if (b.u) b.u.Ba = null, Hc(b, c, d);
            else try {
                b.Uc ? b.Lc.call(b.context) : Hc(b, c, d)
            } catch (e) {
                Ic.call(null, e)
            }
            xc.put(b)
        ...
        function Hc(a, b, c) {
            b == tc ? a.Lc.call(a.context, c) : a.gc && a.gc.call(a.context, c)
        }
        ...
        var Jc = "undefined" != typeof Promise ? Promise : "undefined" != typeof n.Promise ? n.Promise : qc;
        n.setTimeout || (n.setTimeout = function () {
            setTimeout.apply(null, arguments)
        });
        qc.prototype["catch"] = qc.prototype.Kg;

        function C() {
            var a = this;
            this.reject = this.resolve = null;
            this.o = new Jc(function (b, c) {
                a.resolve = b;
                a.reject = c
            })
        }
        ...
        function D(a, b) {
            return function (c, d) {
                ...
                ga(b) && (Kc(a.o), 1 === b.length ? b(c) : b(c, d))
            }
        }
        ...
        function E(a, b, c, d, e) {
            cc.call(this, b.displayName, b.email, b.photoURL, b.providerId, b.uid, b.phone);
        ...
        E.prototype["delete"] = function (a) {
            var b = new C;
            Lc(this.__authManager, this.Ga(), D(b, a));
            return b.o
        };
        ...
        E.prototype.getPhone = E.prototype.ge;
        E.prototype.link = function (a, b) {
            ...
            var c = a.provider,
                ...
                e = {};
            e.idToken = this.Ga();
            "password" == c ? (e.email = a.email, e.password = a.password, Nc(this.__authManager, e, D(d, b))) : (e.providerId = a.provider, e.accessToken = a.accessToken, e.openId = a.openId || "", e.authType = "link", Oc(this.__authManager, e, D(d, b)));
            return d.o
        };
        ...
        E.prototype.Sg = function (a, b) {
            ...
            var c = new C;
            a.idToken = this.Ga();
            Qc(this.__authManager, "profile", a, D(c, b));
            return c.o
        };
        ...
        E.prototype.reload = function (a) {
            ...
            var b = new C;
            Xc(this.__authManager, this.Ga(), D(b, a));
            return b.o
        };
        ...
        function Zc(a) {
            if (a && a.users && a.users[0]) return a = a.users[0], new cc(a.displayName, a.email, a.photoUrl, a.providerId, a.localId, a.phoneNumber);
        ...
        function dd(a, b, c) {
            ...
            this.Tc = b || {};
            this.Y = c || {};
            this.Yc.remember || (this.Yc.remember = "default")
        }
        ...
        function hd(a) {
            v.get("redirect_request_id") && id(a);
            var b = a.lc.get();
        ...
        function kd(a, b, c, d) {
            b && b.idToken ? ld(a, b.idToken, c, function (a, b) {
                d(a, b)
        ...
        function Oc(a, b, c) {
            ...
            var e = Xa(["XHR", "JSONP", "NodeHttp", "WxHttp"]);
            nd(a, e, "/auth/" + b.path, d, function (a, b) {
                z(c, a, b)
            })
        }
        ...
        function od(a, b) {
            ...
            var c = new dd({}, {}, {}),
                d = Xa(["WxImplicit"]);
            nd(a, d, "/auth/wxapp", c, function (a, c) {
                z(b, a, c)
            })
        }
        ...
        function Sc(a, b, c, d) {
            ...
            b.id ? (requestInfo.Y.providerId = b.id, requestInfo.Y.scope = b.scope || "", requestInfo.Y.appId = a.Mb.qc, requestInfo.Tc.window_features = "menubar=yes,modal=yes,alwaysRaised=yeslocation=yes,resizable=yes,scrollbars=yes,status=yes,height=" + height + ",width=" + width + ",top=" + ("object" === typeof screen ? .5 * (screen.height - height) : 0) + ",left=" + ("object" === typeof screen ? .5 * (screen.width - width) : 0), requestInfo.Tc.relay_url = Ma(a.Mb.qc),
                requestInfo.Tc.requestWithCredential = r(a.Xa, a), nd(a, e, "/auth/oauth", requestInfo, function (a, b) {
                    z(d, a, b)
                })) : setTimeout(function () {
                z(d, oa("TRANSPORT_UNAVAILABLE_FOR_UNKNOWN_PROVIDER"))
            }, 0)
        }
        ...
        function Tc(a, b, c, d) {
            ...
            var e = Xa(["Redirect"]);
            c = fd(c);
            b.id ? (c.Y.providerId = b.id, c.Y.scope = b.scope || "", c.Y.appId = a.Mb.qc, v.set("redirect_client_options", c.Yc), nd(a, e, "/auth/oauth", c, function (a, b) {
                z(d, a, b)
            })) : z(d, oa("TRANSPORT_UNAVAILABLE"))
        }
        ...
        function id(a) {
            ...
            if (b) {
                ...
                nd(a, d, "/auth/session", requestInfo, function () {
        ...
        function pd(a, b, c) {
            ...
            a.Xa("/auth/signupNewUser", b, function (b, e) {
                !b && e && e.idToken ? ld(a, e.idToken, null, function (a, b) {
                    z(c, a, b)
                }) : z(c, b)
            })
        }
        ...
        function Qc(a, b, c, d) {
            ...
            qd(a, e, function (b, c) {
                b ? z(d, b) : (a.Qa.currentUser.displayName = g, a.Qa.currentUser.photoURL = f, jd(a, a.Qa), z(d, b, c))
            })
        }
        ...
        gd.prototype.ae = function (a, b) {
            ...
            this.Xa("/auth/getProvider", c, function (a, c) {
                a ? z(b, a) : z(b, a, c.allProviders || [])
            })
        };
        gd.prototype.Xa = function (a, b, c) {
            var d = Xa(["XHR", "JSONP", "NodeHttp", "WxHttp"]);
            rd(this, d, a, b, c)
        };

        function nd(a, b, c, d, e) {
            rd(a, b, c, d, function (b, c) {
                !b && c && c.idToken ? kd(a, c, d.Yc, function (a, b) {
                    a ? e(a) : e(null, b)
        ...
        function Uc(a, b, c) {
            ...
            a.Xa("/auth/verifyPhone", b, function (b, e) {
                ...
                !b && e && e.idToken ? ld(a, e.idToken, null, function (a) {
                    z(c, a)
                }) : z(c, b)
            })
        }
        ...
        function G(a, b, c, d) {
            if ((!d || p(c)) && !ga(c)) throw Error(td(a, b, d) + "must be a valid function.");
        }

        function ud(a, b, c) {
            if (p(c) && (!ha(c) || null === c)) throw Error(td(a, b, !0) + "must be a valid context object.");
        };
        ...
        function yd(a, b) {
            ...
            this.Oe = b;
            for (var c = 0; c < this.Ua.length; c++) this.Ia += zd(this.Ua[c]);
            Ad(this)
        }
        yd.prototype.push = function (a) {
            0 < this.Ua.length && (this.Ia += 1);
            this.Ua.push(a);
            this.Ia += zd(a);
            Ad(this)
        };
        yd.prototype.pop = function () {
            var a = this.Ua.pop();
            this.Ia -= zd(a);
        ...
        function Ad(a) {
            ...
            if (32 < a.Ua.length) throw Error(a.Oe + "path specified exceeds the maximum depth that can be written (32) or object contains a cycle " + Bd(a));
        }
        ...
        function Ed(a) {
            return q(a) && 0 !== a.length && !Cd.test(a)
        }

        function Gd(a) {
            return null === a || q(a) || fa(a) && !Rb(a) || ha(a) && pa(a, ".sv")
        }

        function Hd(a, b, c, d) {
            d && !p(b) || Id(td(a, 1, d), b, c)
        }

        function Id(a, b, c) {
            c instanceof H && (c = new yd(c, a));
            if (!p(b)) throw Error(a + "contains undefined " + Bd(c));
            if (ga(b)) throw Error(a + "contains a function " + Bd(c) + " with contents: " + b.toString());
            if (Rb(b)) throw Error(a + "contains " + b.toString() + " " + Bd(c));
            if (q(b) && b.length > 10485760 / 3 && 10485760 < zd(b)) throw Error(a + "contains a string greater than 10485760 utf8 bytes " + Bd(c) + " ('" + b.substring(0, 50) + "...')");
            if (ha(b)) {
                var d = !1,
                    e = !1;
                qa(b, function (b, g) {
                    if (".value" === b) d = !0;
                    else if (".priority" !== b && ".sv" !== b && (e = !0, !Ed(b))) throw Error(a + " contains an invalid key (" + b + ") " + Bd(c) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
                    c.push(b);
                    Id(a, g, c);
                    c.pop()
                });
                if (d && e) throw Error(a + ' contains ".value" child ' + Bd(c) + " in addition to actual children.");
            }
        }
        ...
        function Jd(a, b) {
            ...
            for (c = 0; c < b.length; c++) {
                ...
                for (var e = d.slice(), f = 0; f < e.length; f++)
                    if ((".priority" !== e[f] || f !== e.length - 1) && !Ed(e[f])) throw Error(a + "contains an invalid key (" + e[f] + ") in path " + d.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
            }
            b.sort(H.Yg);
            e = null;
            for (c = 0; c < b.length; c++) {
        ...
        function Kd(a, b, c) {
            ...
            qa(b, function (a, b) {
                var f = new H(a);
                Id(d, b, c.u(f));
                if (".priority" === xd(f) && !Gd(b)) throw Error(d + "contains an invalid value for '" + f.toString() + "', which must be a valid Firebase priority (a string, finite number, server value, or null).");
                e.push(f)
            });
            Jd(d, e)
        }
        ...
        function Ld(a, b, c) {
            if (Rb(c)) throw Error(td(a, b, !1) + "is " + c.toString() + ", but must be a valid Wilddog priority (a string, finite number, server value, or null).");
            if (!Gd(c)) throw Error(td(a, b, !1) + "must be a valid Wilddog priority (a string, finite number, server value, or null).");
        }
        ...
        function Md(a, b, c) {
            if (!c || p(b)) switch (b) {
                ...
                case "child_moved":
                    break;
                default:
                    throw Error(td(a, 1, c) + 'must be a valid event type: "value", "child_added", "child_removed", "child_changed", or "child_moved".');
            }
        }

        function Nd(a, b, c, d) {
            if ((!d || p(c)) && !Ed(c)) throw Error(td(a, b, d) + 'was an invalid key: "' + c + '".  Wilddog keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]").');
        }

        function Od(a, b) {
            if (!q(b) || 0 === b.length || Dd.test(b)) throw Error(td(a, 1, !1) + 'was an invalid path: "' + b + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');
        }
        ...
        function Pc(a, b, c) {
            if (!q(c)) throw Error(td(a, b, !1) + "must be a valid string.");
        }

        function Mc(a, b) {
            if (!ha(b) || null === b) throw Error(td(a, 1, !1) + "must be a valid object.");
        };
        ...
        M.prototype.onAuthStateChanged = M.prototype.fg;
        ...
        M.prototype.signInAnonymously = M.prototype.zg;
        ...
        M.prototype.signInWeapp = M.prototype.Ag;
        M.prototype.tg = function (a, b) {
        ...
        M.prototype.sendPasswordResetEmail = M.prototype.tg;
        M.prototype.ug = function (a, b) {
        ...
        M.prototype.sendPasswordResetSms = M.prototype.ug;
        M.prototype.Lf = function (a, b, c, d) {
        ...
        M.prototype.confirmPasswordResetSms = M.prototype.Lf;
        M.prototype.ae = function (a, b) {
        ...
        M.prototype.fetchProvidersForEmail = M.prototype.ae;
        M.prototype.Cg = function (a, b) {
        ...
        M.prototype.signInWithCustomToken = M.prototype.Cg;
        M.prototype.Dg = function (a, b, c) {
        ...
        M.prototype.signInWithEmailAndPassword = M.prototype.Dg;
        M.prototype.Eg = function (a, b, c) {
        ...
        M.prototype.signInWithPhoneAndPassword = M.prototype.Eg;
        ...
        M.prototype.signOut = M.prototype.Hg;
        M.prototype.Mf = function (a, b, c) {
        ...
        M.prototype.createUserWithEmailAndPassword = M.prototype.Mf;
        M.prototype.Nf = function (a, b, c) {
        ...
        M.prototype.createUserWithPhoneAndPassword = M.prototype.Nf;
        ...
        M.prototype.signInWithPopup = M.prototype.Fg;
        ...
        M.prototype.signInWithRedirect = M.prototype.Gg;
        ...
        M.prototype.signInWithCredential = M.prototype.Bg;
        ...
        Rd.prototype.ag = function (a, b) {
            var c = b || this.Le;
            this.Ud[c] = new A(a, c);
            if (b == this.Le || null == b) this.app = this.Ud[c];
            return this.Ud[c]
        };
        Rd.prototype.initializeApp = Rd.prototype.ag;
        Rd.prototype.te = function (a, b) {
            this.eg[a] = b;
            ac(a, b);
            this[a] = function () {
                return this.app[a]()
        ...
        Rd.prototype.regService = Rd.prototype.te;
        Rd.prototype.De = CLIENT_VERSION;
        Rd.prototype.SDK_VERSION = Rd.prototype.De;
        var Sd = new Rd;
        ...
        h.Gc = function () {
            return new N("[MAX_NAME]", new ae("[PRIORITY-POST]", Zd))
        };
        h.Fc = function (a, b) {
            var c = O(a);
            return new N(b, new ae("[PRIORITY-POST]", c))
        };
        h.toString = function () {
            return ".priority"
        };
        ...
        h.Gc = function () {
            return new N("[MAX_NAME]", Q)
        };
        h.Fc = function (a) {
            x(q(a), "KeyIndex indexValue must always be a string.");
            return new N(a, Q)
        };
        h.toString = function () {
            return ".key"
        ...
        function he(a, b, c) {
            var d = pb(a.ld, function (d, f) {
                var e = t(a.cc, f);
                x(e, "Missing index implementation for " + f);
                if (d === Wd) {
                    if (e.zc(b.node)) {
        ...
        function ae(a, b) {
            this.I = a;
            x(p(this.I) && null !== this.I, "LeafNode shouldn't be created with null/undefined value.");
            this.fa = b || Q;
            me(this.fa);
            this.yb = null
        }
        ...
        h.K = function (a, b) {
            ...
            x(".priority" !== c || 1 === vd(a), ".priority must be the last token in a path");
        ...
        h.hash = function () {
            if (null === this.yb) {
                ...
                var b = typeof this.I,
                    a = a + (b + ":"),
                    a = "number" === b ? a + Wb(this.I) : a + this.I;
                this.yb = Kb(a)
            }
            return this.yb
        };
        ...
        function te(a, b, c, d, e) {
            ...
            for (this.Ta = []; !a.f();)
                ...
                this.Ta.push(a);
                break
            } else this.Ta.push(a), a = this.le ? a.right : a.left
        }
        ...
        function ue(a) {
            ...
            b = a.Ta;
            b = b[b.length - 1];
            return a.Ed ? a.Ed(b.key, b.value) : {
                key: b.key,
                value: b.value
            }
        }
        ...
        function T(a, b, c) {
            ...
            a.f() && x(!this.fa || this.fa.f(), "An empty node cannot have a priority");
            this.wb = c;
            this.yb = null
        }
        h = T.prototype;
        ...
        h.K = function (a, b) {
            var c = J(a);
            if (null === c) return b;
            x(".priority" !== J(a) || 1 === vd(a), ".priority must be the last token in a path");
        ...
        h.Te = function (a, b, c) {
            return (c = Ge(this, c)) ? (a = se(c, new N(a, b))) ? a.name : null : se(this.w, a)
        };

        function He(a, b) {
            var c;
            c = (c = Ge(a, b)) ? (c = c.Ic()) && c.name : a.w.Ic();
            return c ? new N(c, a.w.get(c)) : null
        }
        ...
        h.pb = function (a) {
            if (a === ce || wb(this.wb.cc, a.toString())) return this;
            var b = this.wb,
                c = this.w;
            x(a !== ce, "KeyIndex always exists and isn't meant to be added to the IndexMap.");
        ...
        h.Ac = function (a) {
            return a === ce || wb(this.wb.cc, a.toString())
        };
        h.da = function (a) {
            if (a === this) return !0;
            if (a.R()) return !1;
        ...
        function O(a, b) {
            ...
            if ("object" !== typeof a || ".sv" in a) return new ae(a, O(c));
            ...
            qa(k, function (a) {
                if ("string" !== typeof a || "." !== a.substring(0, 1)) {
                    var b = O(k[a]);
                    b.f() || (g = g || !b.G().f(), f.push(new N(a, b)))
                }
            });
            ...
            if (g) {
                var m = je(f, Xd(R));
                return new T(l, O(c), new ge({
                    ".priority": m
                }, {
                    ".priority": R
                }))
            }
            return new T(l, O(c), le)
        }
        var Ke = Math.log(2);
        ...
        function je(a, b, c, d) {
            ...
            var f = function (b) {
                ...
                for (var f = null, g = null, P = a.length, B = 0; B < b.count; ++B) {
                    var ca = Me(b),
                        Fd = Math.pow(2, b.count - (B + 1));
                    ca ? d(Fd, re) : (d(Fd, re), d(Fd, we))
                }
                return g
            }(new Le(a.length));
        ...
        function ne(a) {
            return "number" === typeof a ? "number:" + Wb(a) : "string:" + a
        }

        function me(a) {
            if (a.R()) {
                var b = a.O();
                x("string" === typeof b || "number" === typeof b || "object" === typeof b && pa(b, ".sv"), "Priority must be a string or number.")
            } else x(a === Zd || a.f(), "priority of unexpected type.");
            x(a === Zd || a.G().f(), "Priority nodes can't have a priority of their own.")
        }
        ...
        U.prototype.hasChildren = U.prototype.fd;
        U.prototype.name = function () {
            y("Wilddog.DataSnapshot.name() being deprecated. Please use Wilddog.DataSnapshot.key() instead.");
        ...
        function Oe() {
            ...
            if ("undefined" !== typeof window && "undefined" !== typeof window.addEventListener) {
                ...
                window.addEventListener("online", function () {
                    a.hc || (a.hc = !0, a.Od("online", !0))
                }, !1);
                window.addEventListener("offline", function () {
                    a.hc && (a.hc = !1, a.Od("online", !1))
                }, !1)
            }
        }
        la(Oe, Zb);
        Oe.prototype.fe = function (a) {
        ...
        function Pe() {
            ...
            if (b) {
                ...
                document.addEventListener(b,
                    function () {
                        var b = !document[a];
                        b !== c.oc && (c.oc = b, c.Od("visible", b))
                    }, !1)
            }
        }
        la(Pe, Zb);
        Pe.prototype.fe = function (a) {
            ...
            return function (b) {
                ...
                if (0 != b.charAt(0))
                    if (2 == b.charAt(0)) {
                        ...
                        b = c[1];
                        "wd" == c[0] ? "c" == b.t ? (c = b.d, "h" == c.t ? Ye(a, c.d) : "r" == c.t ? (c = c.d, a.m("Reset packet received.  New host: " + c), Ze(a.F, c), a.close()) : "s" == c.t && (a.hg(c.d), a.close())) : "d" == b.t && a.vd(b.d) : a.m("eventType not known")
        ...
        function Xe(a) {
            return function () {
                2 !== a.Z && (a.m("Closing realtime connection."), a.Z = 2, a.Aa && (a.Aa(), a.Aa = null))
            }
        }
        ...
        function Ve(a) {
            return function (b) {
                if (0 == a.Z) {
                    var c = a.F.za,
                        d = a.F;
                    !Ya.Sc && null != c && 0 > d.lb.indexOf(c) && c != d.host && (d.lb.push(c), v.set("failHosts", JSON.stringify(d.lb)));
        ...
        function Ye(a, b) {
            var c = b.ts,
                ...
                e = b.h;
            a.sessionId = b.s;
            "1.0" != d && y("Protocol version mismatch detected");
            0 == a.Z && (e == a.F.za || a.F.tf ? (a.Z = 1, a.m("realtime state connected"), $e(a.F, a.F.za), a.Mc && (a.Mc(c), a.Mc = null)) : (Ze(a.F, e), a.m("updateHost ", e), a.Ja.close(), Te(a, ["websocket"], function (b) {
                a.Ja = b;
                a.Ja.on("open", Ue(a));
                a.Ja.on("error", Ve(a))
            })))
        ...
        function af(a, b) {
            if (a.F.za) b(a.F.za);
                ...
                var c = Xa(["XHR", "JSONP", "NodeHttp", "WxHttp"]),
                    c = db(c, function (a) {
                        return "function" === typeof a.isAvailable && a.isAvailable()
                    });
                ...
                })).open(("undefined" == typeof document ? "http" : "https") + "://ns.wilddog.com/v1/lookup?appId=" + a.F.oe, null, function (c, e) {
        ...
        Re.prototype.close = function () {
            2 !== this.Z && (this.m("Closing realtime connection."), this.Z = 2, this.Ja && this.Ja.close(), this.Aa && (this.Aa(), this.Aa = null))
        };
        Re.prototype.Yd = function () {
        ...
        h.eb = function (a, b, c) {
            ...
            this.m(u(a));
            x(this.qa, "sendRequest call when we're not connected not allowed.");
            this.Va.eb(a);
            c && (this.Dd[d] = c)
        };
        h.Ze = function (a, b, c, d) {
            var e = ff(a),
                f = a.path.toString();
            this.m("Listen called for " + f + " " + e);
            this.ja[f] = this.ja[f] || {};
            x(!this.ja[f][e], "listen() called twice for same path/queryId.");
            a = {
                N: d,
                gd: b,
                query: a,
        ...
        function gf(a, b) {
            ...
            a.eb("q", f, function (f) {
                ...
                if (g && "object" === typeof g && pa(g, "w")) {
                    var m = t(g, "w");
                    ea(m) && 0 <= cb(m, "no_index") && y("Using an unspecified index. Consider adding " + ('".indexOn": "' + c.B.g.toString() + '"') + " at " + c.path.toString() + " to your security rules for better performance")
                }(a.ja[d] && a.ja[d][e]) === b && (a.m("listen response", f), "ok" !== l && jf(a, d, e), b.N &&
                    b.N(l, g))
            })
        }
        h.He = function (a, b, c) {
            ...
            this.m("Authenticating using credential: " + a);
            kf(this);
            40 == a.length && (this.m("Admin auth credential detected.  Reducing max reconnect time."), this.qd = 3E4)
        };
        h.wf = function (a) {
            delete this.Ka;
        ...
        function kf(a) {
            ...
            a.qa && b && a.eb("auth", {
                ...
                b.Qe ? "ok" !== d && b.Wc && b.Wc(d, c) : (b.Qe = !0, b.tc && b.tc(d, c))
            })
        }
        h.xf = function (a, b) {
            var c = a.path.toString(),
                d = ff(a);
            this.m("Unlisten called for " + c + " " + d);
            if (jf(this, c, d) && this.qa) {
                var e = hf(a.B);
                this.m("Unlisten on " + c + " for " + d);
                c = {
                    p: c
                };
                b && (c.q = e, c.t = b);
        ...
        function mf(a, b, c, d, e, f) {
            ...
            a.Oc++;
            b = a.ta.length - 1;
            a.qa ? nf(a, b) : a.m("Buffering put: " + c)
        }
        ...
        h.ue = function (a) {
            if (this.qa) {
                ...
                this.m("reportStats", a);
                var b = this;
                this.eb("s", a, function (a) {
                    "ok" !== a.s && b.m("reportStats", "Error sending stats: " + a.d)
                })
            }
        };
        h.gg = function (a) {
            if ("r" in a) {
                this.m("from server: " + u(a));
                var b = a.r,
                    c = this.Dd[b];
                c && (delete this.Dd[b], c(a.b))
            } else {
                if ("error" in a) throw "A server-side error has occurred: " + a.error;
                "a" in a && (b = a.a, c = a.b, this.m("handleServerMessage", b, c), "d" === b ? this.Cb(c.p, c.d, !1, c.t) : "m" === b ? this.Cb(c.p, c.d, !0, c.t) : "c" === b ? of (this, c.p, c.q) : "ac" === b ? (a = c.s, b = c.d, c = this.Ka, delete this.Ka, c && c.Wc && c.Wc(a, b)) : "sd" === b ? this.we ? this.we(c) : "msg" in c && "undefined" !== typeof console && console.log("WILDDOG: " + c.msg.replace("\n",
                    "\nWILDDOG: ")) : Pb("Unrecognized action received from server: " + u(b) + "\nAre you using the latest client?"))
            }
        };
        h.Mc = function (a) {
            this.m("connection ready");
            this.qa = !0;
        ...
        function df(a, b) {
            x(!a.Va, "Scheduling a connect when we're already connected/ing?");
        ...
        h.lg = function (a) {
            a && !this.oc && this.cb === this.qd && (this.m("Window became visible.  Reducing delay."), this.cb = 1E3, this.Va || df(this, 0));
            this.oc = a
        };
        h.jg = function (a) {
            a ? (this.m("Browser went online."), this.cb = 1E3, this.Va || df(this, 0)) : (this.m("Browser went offline.  Killing connection."), this.Va && this.Va.close())
        };
        h.df = function () {
            this.m("data client disconnected");
            this.qa = !1;
            this.Va = null;
            ...
            0 === this.Oc && (this.ta = []);
            this.Dd = {};
            rf(this) && (this.oc ? this.Bc && (3E4 < (new Date).getTime() - this.Bc && (this.cb = 1E3), this.Bc = null) : (this.m("Window isn't visible.  Delaying reconnect."), this.cb = this.qd, this.me = (new Date).getTime()), a = Math.max(0, this.cb - ((new Date).getTime() - this.me)), a *= Math.random(),
                this.m("Trying to reconnect in " + a + "ms"), df(this, a), this.cb = Math.min(this.qd, 1.3 * this.cb));
            this.Jc(!1)
        };

        function qf(a) {
            if (rf(a)) {
                a.m("Making a connection attempt");
        ...
        function jf(a, b, c) {
            b = (new H(b)).toString();
            var d;
            p(a.ja[b]) ? (d = a.ja[b][c], delete a.ja[b][c], 0 === rb(a.ja[b]) && delete a.ja[b]) : d = void 0;
            return d
        }
        ...
        function tf(a, b) {
            if (p(b)) return "tag$" + b;
            var c = a.B;
            x(uf(c) && c.g == R, "should have a tag if it's not a default query.");
            return a.path.toString()
        }
        h = sf.prototype;
        h.Ze = function (a, b, c, d) {
            var e = a.path.toString();
            this.m("Listen called for " + e + " " + ff(a));
            var f = tf(a, c),
                g = {};
            this.ja[f] = g;
            a = vf(a.B);
        ...
        function wf(a, b, c, d) {
            ...
            a.m("Sending REST request for " + e);
            var f = new XMLHttpRequest;
            f.onreadystatechange = function () {
                if (d && 4 === f.readyState) {
                    a.m("REST Response for " + e + " received. status:", f.status, "response:", f.responseText);
                    var b = null;
                    if (200 <= f.status && 300 > f.status) {
                        try {
                            b = Ca(f.responseText)
                        } catch (k) {
                            y("Failed to parse JSON response for " + e + ": " + f.responseText)
                        }
                        d(null, b)
                    } else 401 !== f.status && 404 !==
                        f.status && y("Got unsuccessful REST response for " + e + " Status: " + f.status), d(f.status);
                    d = null
                }
            };
            f.open("GET", e, !0);
        ...
        Ef.prototype.Nc = function () {
            return this.path.f() ? this : new Ef(K(this.path), this.ve)
        };
        ...
        Hf.prototype.Nc = function (a) {
            if (this.path.f()) return a = this.children.subtree(new H(a)), a.f() ? null : a.value ? new Jf(this.source, L, a.value) : new Hf(this.source, L, a);
            x(J(this.path) === a, "Can't get a merge for a child not on the path of the operation");
        ...
        Jf.prototype.Nc = function (a) {
            return this.path.f() ? new Jf(this.source, L, this.Na.P(a)) : new Jf(this.source, K(this.path), this.Na)
        };
        ...
        Lf.prototype.Nc = function () {
            return this.path.f() ? new Lf(this.source, L) : new Lf(this.source, K(this.path))
        };
        ...
        Nf.prototype.toString = function () {
            return this.ce ? "user" : this.Ce ? "server(queryID=" + this.Fb + ")" : "server"
        };
        ...
        function $f(a, b, c) {
            if (!b.f()) {
                var d = !0;
                a.value && (d = c(L, a.value));
                !0 === d && (d = J(b), (a = a.children.get(d)) && ag(a, K(b), L.u(d), c))
            }
        }
        ...
        function hg(a, b, c, d) {
            return new gg(new eg(b, c, d), a.Gd)
        }
        ...
        kg.prototype.Yb = function () {
            var a = this.Hd.kc();
            return "value" === this.cd ? a.path : a.parent().path
        };
        kg.prototype.ee = function () {
            return this.cd
        };
        kg.prototype.Tb = function () {
            return this.Zd.Tb(this)
        };
        kg.prototype.toString = function () {
            return this.Yb().toString() + ":" + this.cd + ":" + u(this.Hd.Pe())
        };
        ...
        h.Tb = function (a) {
            var b = this.tb;
            if ("cancel" === a.ee()) {
                x(this.sb, "Raising a cancel event on a listener with no cancel callback");
                var c = this.sb;
                return function () {
                    c.call(b, a.error)
                }
        ...
        h.pf = function (a) {
            ...
            return vb(this.ma, "children_removed" === a ? "child_removed" : a)
        };
        h.Je = function (a, b) {
            return this.sb ? new lg(this, a, b) : null
        };
        h.createEvent = function (a, b) {
            x(null != a.$a, "Child events should have a childName.");
            var c = b.kc().u(a.$a);
            return new kg(a.type, this, new U(a.Oa, c, b.B.g), a.Ad)
        };
        h.Tb = function (a) {
            var b = this.tb;
            if ("cancel" === a.ee()) {
            ...
            if (a instanceof ng) {
                ...
                if (this.tb === a.tb) {
                    ...
                    if (b === rb(this.ma)) {
                        ...
                        return qb(this.ma, function (b, c) {
                            return a.ma[c] === b
                        })
                    }
                }
        ...
        function pg(a, b, c, d) {
            var e = [],
                f = [];
            ta(b, function (b) {
                "child_changed" === b.type && a.g.kd(b.pe, b.Oa) && f.push(new V("child_moved", b.Oa, b.$a))
            });
        ...
        function rg(a, b, c) {
            "value" !== b.type && "child_removed" !== b.type && (b.Ad = c.Te(b.$a, b.Oa, a.g));
            return b
        }
        og.prototype.Kf = function (a, b) {
            if (null == a.$a || null == b.$a) throw Ib("Should only compare child_ events.");
            return this.g.compare(new N(a.$a, a.Oa), new N(b.$a, b.Oa))
        };
        ...
        ug.prototype.Se = function (a) {
            ...
            b = null != this.wd ? new eg(this.wd, !0, !1) : this.Pa.C();
            return this.yf.Za(a, b)
        };
        ug.prototype.de = function (a, b, c) {
            var d = null != this.wd ? this.wd : jg(this.Pa);
            a = this.yf.Wd(d, b, 1, c, a);
        ...
        wg.prototype.fb = function (a, b, c, d) {
            var e = new xg,
                f;
            if (b.type === Kf) b.source.ce ? c = yg(this, a, b.path, b.Na, c, d, e) : (x(b.source.Re, "Unknown source."), f = b.source.Ce, c = zg(this, a, b.path, b.Na, c, d, f, e));
            else if (b.type === If) b.source.ce ? c = Ag(this, a, b.path, b.children, c, d, e) : (x(b.source.Re, "Unknown source."), f = b.source.Ce, c = Bg(this, a, b.path, b.children, c, d, f, e));
            else if (b.type === Ff)
                if (b.ve)
                    if (f = b.path, null != c.mc(f)) c = a;
                        ...
                        b = new ug(c, a, d);
                        d = a.J.j();
                        if (f.f() || ".priority" === J(f)) a.C().M ? b = c.ya(jg(a)) : (b = a.C().j(), x(b instanceof T, "serverChildren would be complete if leaf node"), b = c.sc(b)), b = this.L.xa(d, b, e);
                        else {
                            f = J(f);
                            var g = c.Za(f, a.C());
            ...
            else throw Ib("Unknown operation type: " + b.type);
            e = tb(e.kb);
            d = c;
            b = d.J;
        ...
        function Dg(a, b, c, d, e, f) {
            ...
            var k;
            if (c.f()) x(b.C().M, "If change path is empty, we must have complete server data"), b.C().Sb ? (e = jg(b), d = d.sc(e instanceof T ? e : Q)) : d = d.ya(jg(b)), f = a.L.xa(b.J.j(), d, f);
            else {
                var l = J(c);
                if (".priority" == l) x(1 == vd(c), "Can't have a priority with additional path components"), f = g.j(), k = b.C().j(), d = d.Vc(c, f, k), f = null != d ? a.L.ga(f, d) : g.j();
                else {
                    var m = K(c);
                    fg(g, l) ? (k = b.C().j(), d = d.Vc(c, g.j(), k), d = null != d ? g.j().P(l).K(m, d) : g.j().P(l)) : d = d.Za(l, b.C());
        ...
        function zg(a, b, c, d, e, f, g, k) {
            ...
            if (c.f()) d = g.xa(l.j(), d, null);
                ...
                var m = J(c);
                if ((c.f() ? !l.M || l.Sb : !fg(l, J(c))) && 1 < vd(c)) return b;
                d = l.j().P(m).K(K(c), d);
        ...
        function yg(a, b, c, d, e, f, g) {
            ...
            if (c.f()) g = a.L.xa(b.J.j(), d, g), a = hg(b, g, !0, a.L.La());
                ...
                if (!l.f()) {
                    var m = e.Se(f);
                    d = null != m ? ".priority" === xd(l) && m.sa(l.parent()).f() ? m : m.K(l, d) : Q
                }
        ...
        function Bg(a, b, c, d, e, f, g, k) {
            ...
            c.children.na(function (c, d) {
                if (m.Ma(c)) {
                    var B = b.C().j().P(c),
                        B = Eg(B, d);
                    l = zg(a, l, new H(c), B, e, f, g, k)
                }
            });
            c.children.na(function (c, d) {
                var B = !b.C().M && null == d.value;
                m.Ma(c) || B || (B = b.C().j().P(c), B = Eg(B, d), l = zg(a, l, new H(c), B, e, f, g, k))
            });
            return l
        }
        ...
        function Cg(a, b, c, d, e, f) {
            ...
            if (b.C().M) {
                ...
                l = J(c);
                if (1 == vd(c) || fg(b.J, l)) c = d.Za(l, b.C()), null != c && (k = a.L.K(e, l, c, g,
                    f));
                e = !1
            }
        ...
        h.fb = function (a, b, c) {
            a.type === If && null !== a.source.Fb && (x(jg(this.Pa), "We should always have a full cache before handling merges"), x(ig(this.Pa), "Missing event cache, even though we have a server cache"));
            var d = this.Pa;
            a = this.kf.fb(d, a, b, c);
            b = this.kf;
            c = a.Qd;
            x(c.J.j().Ac(b.L.g), "Event snap not indexed");
            x(c.C().j().Ac(b.L.g), "Server snap not indexed");
            x(a.Qd.C().M || !d.C().M, "Once a server snap is complete, it should never go back");
            this.Pa = a.Qd;
            return Jg(this, a.If, a.Qd.J.j(), null)
        };
        ...
        h.fb = function (a, b, c) {
            var d = a.source.Fb;
            if (null !== d) return d = t(this.Da, d), x(null != d, "SyncTree gave us an op for an invalid query."), d.fb(a, b, c);
            var e = [];
        ...
        function Wg(a, b, c) {
            ...
            b.children.na(function (b, f) {
                ".priority" === b ? (x(null !== f.value, "Priority writes must always be leaf nodes"), d = f.value) : c = Wg(a.u(b), f, c)
            });
        ...
        h = Xg.prototype;
        h.Bd = function (a) {
            var b = ib(this.Ea, function (b) {
                return b.Sd === a
            });
            x(0 <= b, "removeWrite called with nonexistent writeId.");
            var c = this.Ea[b];
            this.Ea.splice(b, 1);
            ...
            if (d) {
                if (e) this.V = Zg(this.Ea, $g, L), this.Cc = 0 < this.Ea.length ? this.Ea[this.Ea.length - 1].Sd : -1;
                else if (c.Na) this.V = this.V.Bd(c.path);
                else {
                    var k = this;
                    w(c.children, function (a, b) {
                        k.V = k.V.Bd(c.path.u(b))
                    })
                }
                return c.path
            }
        ...
        h.ya = function (a, b, c, d) {
            if (c || d) {
                var e = Vg(this.V, a);
                return !d && e.f() ? b : d || null != b || null != Tg(e, L) ? (e = Zg(this.Ea, function (b) {
                    return (b.visible || d) && (!c || !(0 <= cb(c, b.Sd))) && (b.path.contains(a) || a.contains(b.path))
                }, a), b = b || Q, e.apply(b)) : null
            }
            e = Tg(this.V, a);
            if (null != e) return e;
            e = Vg(this.V, a);
            return e.f() ? b : null != b || null != Tg(e, L) ? (b = b || Q, e.apply(b)) : null
        };
        h.sc = function (a, b) {
            var c = Q,
                d = Tg(this.V, a);
        ...
        function Yg(a, b) {
            return a.Na ? a.path.contains(b) : !!xb(a.children, function (c, d) {
        ...
        function Zg(a, b, c) {
            for (var d = Qg, e = 0; e < a.length; ++e) {
                ...
                if (b(f)) {
                    var g = f.path;
                    if (f.Na) c.contains(g) ? (g = I(c, g), d = Rg(d, g, f.Na)) : g.contains(c) && (g = I(g, c), d = Rg(d, L, f.Na.sa(g)));
                    else if (f.children)
                        if (c.contains(g)) g = I(c, g), d = Sg(d, g, f.children);
                        else {
                            if (g.contains(c))
                                if (g = I(g, c), g.f()) d = Sg(d, L, f.children);
                                else if (f = t(f.children, J(g))) f = f.sa(K(g)), d = Rg(d, L, f)
                        }
                    else throw Ib("WriteRecord should have .snap or .children");
                }
            }
            return d
        }
        ...
        h.Vc = function (a, b, c) {
            return this.$.Vc(this.Jb, a, b, c)
        };
        h.mc = function (a) {
            return this.$.mc(this.Jb.u(a))
        };
        h.Wd = function (a, b, c, d, e) {
            return this.$.Wd(this.Jb, a, b, c, d, e)
        };
        h.Za = function (a, b) {
        ...
        function ch(a, b, c, d, e) {
            var f = a.Eb,
                g = e;
            x(d > f.Cc, "Stacking an older write on top of newer ones");
            p(g) || (g = !0);
            f.Ea.push({
                path: b,
                Na: c,
        ...
        function eh(a, b, c, d) {
            var e = a.Eb;
            x(d > e.Cc, "Stacking an older merge on top of newer ones");
            e.Ea.push({
                path: b,
                children: c,
                Sd: d,
        ...
        bh.prototype.Lb = function (a, b) {
            ...
            var f = this.wa.get(c);
            f ? (e = e || null != Mg(f), d = d || f.mb(L)) : (f = new Lg, this.wa = this.wa.set(c, f));
            var g;
            ...
            if (!k && !uf(a.B)) {
                var l = mh(a);
                x(!vb(this.jc, l), "View does not exist, but we have a tag");
                var m = nh++;
                this.jc[l] = m;
                this.Be["_" + m] = l
            }
                ...
                if (b && !g && (d = this.wa.subtree(d), !d.f()))
                    for (var d = ph(d), k = 0; k < d.length; ++k) {
                        var l = d[k],
                            m = l.X,
                            l = qh(this, l);
                        this.Dc.xe(m, rh(this, m), l.gd, l.N)
                    }
                if (!g && 0 < e.length && !c)
                    if (b) this.Dc.Kd(a, null);
                    else {
                        var P = this;
                        ta(e, function (a) {
                            ff(a);
        ...
        function oh(a, b, c) {
            var d = b.path,
                e = rh(a, b);
            c = qh(a, c);
            b = a.Dc.xe(b, e, c.gd, c.N);
            d = a.wa.subtree(d);
            if (e) x(null == Mg(d.value), "If we're adding a query, it shouldn't be shadowed");
            else
                for (e = Wf(d, function (a, b, c) {
                        if (!a.f() && b && null != Mg(b)) return [Mg(b).X];
                        var d = [];
                        b && (d = d.concat(eb(Ng(b), function (a) {
                            return a.X
                        })));
                        w(c, function (a) {
                            d = d.concat(a)
                        ...
                        return d
                    }), d = 0; d < e.length; ++d) c = e[d], a.Dc.Kd(c, rh(a, c));
            return b
        }
        ...
        function dh(a, b) {
            return th(a, b, a.wa, null, new ah(L, a.Eb))
        }

        function th(a, b, c, d, e) {
            if (b.path.f()) return uh(a, b, c, d, e);
            var f = c.get(L);
            null == d && null != f && (d = f.mb(L));
            var g = [],
                k = J(b.path),
                l = b.Nc(k);
        ...
        wh.prototype.get = function () {
            var a = this.Jf.get(),
                b = Ab(a);
            if (this.nd)
                for (var c in this.nd) b[c] -= this.nd[c];
            this.nd = a;
            return b
        };
        ...
        function Eh(a, b) {
            ...
            if (a.R()) {
                var e = Ch(a.Ha(), b);
                return e !== a.Ha() || c !== a.G().O() ? new ae(e, O(c)) : a
            }
            d = a;
        ...
        h.path = function () {
            return new H(null === this.Ba ? this.rd : this.Ba.path() + "/" + this.rd)
        };
        h.name = function () {
            return this.rd
        };
        ...
        function Jh(a) {
            if (null !== a.Ba) {
                var b = a.Ba,
                    ...
                    d = a.f(),
                    e = pa(b.H.children, c);
                d && e ? (delete b.H.children[c], b.H.Xc--, Jh(b)) : d || e || (b.H.children[c] = a.H, b.H.Xc++, Jh(b))
            }
        };
        ...
        function Qh(a, b) {
            for (var c = !0, d = 0; d < a.ub.length; d++) {
                ...
                if (e)
                    if (e = e.Yb(), b(e)) {
                        for (var e = a.ub[d], f = 0; f < e.dd.length; f++) {
                            var g = e.dd[f];
                            if (null !== g) {
                                e.dd[f] = null;
                                var k = g.Tb();
                                Mb && Ra("event: " + g.toString());
                                Yb(k)
                            }
                        }
                        a.ub[d] = null
        ...
        function Sh(a, b, c) {
            ...
            this.md = new bh({
                xe: function (a, b, c, k) {
                    b = [];
                    c = d.ie.j(a.path);
                    c.f() || (b = dh(d.md, new Jf(Of, a.path, c)), setTimeout(function () {
                        k("ok")
                    }, 0));
                    return b
                },
            ...
            this.la.bind(this.la.qb.gb, function (a) {
                a && a.signIn ? d.ka.He(a.idToken, function (b, c) {
                    d.Nb(b, c, a)
                }, function (a, b) {
                    Th(d, a, b)
        ...
        function Vh(a) {
            a = a.ie.j(new H(".info/serverTimeOffset")).O() || 0;
        ...
        h.Cb = function (a, b, c, d) {
            ...
            a = [];
            d ? c ? (b = pb(b, function (a) {
                return O(a)
            }), a = lh(this.S, e, b, d)) : (b = O(b), a = hh(this.S, e, b, d)) : c ? (d = pb(b, function (a) {
                return O(a)
            }), a = gh(this.S, e, d)) : (d = O(b), a = dh(this.S, new Jf(Of, e, d)));
            d = e;
        ...
        function Yh(a) {
            a.m("onDisconnectEvents");
            var b = Wh(a),
                c = [];
            Df(Dh(a.Aa, b), L, function (b, e) {
        ...
        h.ud = function (a, b) {
            var c = this;
            this.ka.ud(a.toString(), function (d, e) {
                "ok" === d && Cf(c.Aa, a);
                Zh(b, d, e)
            })
        };
        ...
        function ai(a, b, c, d) {
            var e = O(c);
            a.ka.qe(b.toString(), e.O(!0), function (c, g) {
                "ok" === c && Bf(a.Aa, b, e);
                Zh(d, c, g)
            })
        }
        ...
        function bi(a, b, c, d, e) {
            var f = O(c, d);
            a.ka.qe(b.toString(), f.O(!0), function (c, d) {
                "ok" === c && Bf(a.Aa, b, f);
                Zh(e, c, d)
            })
        }
        ...
        function di(a, b, c) {
            c = ".info" === J(b.path) ? a.md.Lb(b, c) : a.S.Lb(b, c);
            Ph(a.ha, b.path, c)
        }
        h.yc = function () {
            this.bb && this.bb.yc()
        ...
        h.ye = function (a) {
            if ("undefined" !== typeof console) {
                a ? (this.Id || (this.Id = new wh(this.Jd)), a = this.Id.get()) : a = this.Jd.get();
                var b = fb(ub(a), function (a, b) {
        ...
        function ei(a, b, c, d, e) {
            ...
            this.oe = c;
            this.yd = e || "";
            Ya.Sc ? (this.tf = !0, this.za = Ya.Sc) : (this.za = (a = Ua.get("host:" + a)) && a.split(",ts:")[1] >= Date.now() - 72E5 ? a.split(",ts:")[0] : null, this.tf = !1);
        ...
        function Ze(a, b) {
            Ya.Sc || (null == b ? (a.za = a.host, "s-" === a.za.substr(0, 2) && Ua.remove("host:" + a.host)) : b !== a.za && 0 < b.indexOf(".wilddogio.com") && (a.za = b, "s-" === a.za.substr(0, 2) && Ua.set("host:" + a.host, a.za + ",ts:" + Date.now())))
        }
        ...
        function fi(a, b, c, d, e) {
            ...
            if (p(d)) {
                ...
                k.push(c);
                Ih(e, k);
                "object" === typeof d && null !== d && pa(d, ".priority") ? (k = t(d, ".priority"), x(Gd(k), "Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")) :
                    k = (a.S.ya(b) || Q).G().O();
                e = Wh(a);
                d = O(d, k);
                e = Eh(d, e);
                ...
                c.ad = e;
                c.Fa = a.sd++;
                c = ch(a.S, b, e, c.Fa, c.Ge);
                Rh(a.ha, b, c);
                gi(a)
            } else c.Pd(), c.$c = null, c.ad = null, c.N && (a = new U(c.Zc, new W(a.la, a, c.path), R), c.N(null, !1, a))
        }
        ...
        function gi(a, b) {
            ...
            } else c.fd() && c.W(function (b) {
                gi(a, b)
            })
        }

        function ji(a, b, c) {
            for (var d = eb(c, function (a) {
                    return a.Fa
            ...
            a.ka.put(b.toString(), d, function (d) {
                ...
                if ("ok" === d) {
                    ...
                    gi(a);
                    Rh(a.ha, b, e);
                    for (f = 0; f < d.length; f++) Yb(d[f])
                } else {
                    if ("datastale" === d)
                        for (f = 0; f < c.length; f++) c[f].status = 4 === c[f].status ? 5 : 1;
                    else
                        for (y("transaction at " + b.toString() + " failed: " + d), f = 0; f < c.length; f++) c[f].status = 5, c[f].Td = d;
                    Xh(a, b)
                }
            }, e)
        }
        ...
        function li(a, b, c) {
            if (0 !== b.length) {
                for (var d = [], e = [], f = eb(b, function (a) {
                    ...
                    if (5 === k.status) m = !0, P = k.Td, e = e.concat(fh(a.S, k.Fa, !0));
                    else if (1 === k.status)
                        if (25 <= k.rf) m = !0, P = "maxretry", e = e.concat(fh(a.S, k.Fa, !0));
                        else {
                            var B = a.S.ya(k.path, f) || Q;
                            k.Zc = B;
                            var ca = b[g].update(B.O());
                            p(ca) ? (Id("transaction failed: Data returned ", ca, k.path), l = O(ca), "object" === typeof ca &&
                                null != ca && pa(ca, ".priority") || (l = l.ga(B.G())), B = k.Fa, ca = Wh(a), ca = Eh(l, ca), k.$c = l, k.ad = ca, k.Fa = a.sd++, jb(f, B), e = e.concat(ch(a.S, k.path, ca, k.Fa, k.Ge)), e = e.concat(fh(a.S, B, !0))) : (m = !0, P = "nodata", e = e.concat(fh(a.S, k.Fa, !0)))
                        }
                    Rh(a.ha, c, e);
                    e = [];
                    m && (b[g].status = 3, setTimeout(b[g].Pd, Math.floor(0)), b[g].N && ("nodata" === P ? (k = new W(a.la, a, b[g].path), d.push(r(b[g].N, null, null, !1, new U(b[g].Zc, k, R)))) : d.push(r(b[g].N, null, Error(P), !1, null))))
                }
                hi(a, a.nc);
                for (g = 0; g < d.length; g++) Yb(d[g]);
                gi(a)
            }
        }
        ...
        function ni(a, b) {
            var c = b.Ha();
            if (null !== c) {
                for (var d = [], e = [], f = -1, g = 0; g < c.length; g++) 4 !== c[g].status && (2 === c[g].status ? (x(f === g - 1, "All SENT items should be at beginning of queue."), f = g, c[g].status = 4, c[g].Td = "set") : (x(1 === c[g].status, "Unexpected transaction status in abort"), c[g].Pd(), e = e.concat(fh(a.S, c[g].Fa, !0)), c[g].N && d.push(r(c[g].N, null, Error("set"), !1, null)))); - 1 === f ? Ih(b, null) : c.length = f + 1;
                Rh(a.ha, b.path(), e);
                for (g = 0; g < d.length; g++) Yb(d[g])
            }
        };
        ...
        function pi(a) {
            ...
            this.jb = a;
            this.Md = "*";
            Na() ? this.Hc = this.jd = Ga() : (this.Hc = window.opener, this.jd = window);
            if (!b.Hc) throw "Unable to find relay frame";
            Ha(this.jd, "message", r(this.vd, this));
            Ha(this.jd, "message", r(this.bf, this));
            try {
                qi(this, {
                    a: "ready"
                })
        ...
        function qi(a, b) {
            b = u(b);
            Na() ? a.Hc.doPost(b, a.Md) : a.Hc.postMessage(b, a.Md)
        }
        pi.prototype.vd = function (a) {
            var b = this,
                c;
            try {
                c = Ca(a.data)
            } catch (d) {}
            c && "request" === c.a && (Ia(window, this.vd), this.Md = a.origin, this.jb && setTimeout(function () {
                b.jb(b.Md, c.d, function (a, c) {
                    b.Gf = !c;
                    b.jb = void 0;
                    qi(b, {
                        a: "response",
        ...
        X.statsIncrementCounter = X.ze;
        X.bd = function (a) {
            return a.D.bd
        };
        X.dataUpdateCount = X.bd;
        X.bg = function (a, b) {
            a.D.je = b
        };
        ...
        Y.prototype.update = function (a, b) {
            ...
            if (ea(a)) {
                ...
                a = c;
                y("Passing an Array to Wilddog.onDisconnect().update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")
            }
            Kd("Wilddog.onDisconnect().update", a, this.ua);
            G("Wilddog.onDisconnect().update", 2, b, !0);
            c = new C;
            ci(this.Pc, this.ua, a, D(c, b));
            return c.o
        };
        ...
        h.K = function (a, b, c, d, e) {
            x(a.Ac(this.g), "A node must be indexed if only a child is updated");
            d = a.P(b);
            if (d.da(c)) return a;
            null != e && (c.f() ? a.Ma(b) ? ri(e, new V("child_removed", d, b)) : x(a.R(), "A child remove without an old child only makes sense on a leaf node") : d.f() ? ri(e, new V("child_added", c, b)) : ri(e, new V("child_changed", c, b, d)));
        ...
        h.K = function (a, b, c, d, e) {
            this.matches(new N(b, c)) || (c = Q);
            return this.he.K(a, b, c, d, e)
        };
        h.xa = function (a, b, c) {
            b.R() && (b = Q);
            var d = b.pb(this.g),
                ...
                e = this;
            b.W(R, function (a, b) {
                e.matches(new N(a, b)) || (d = d.T(a, Q))
            });
            return this.he.xa(a, d, c)
        };
        h.ga = function (a) {
            return a
        };
        ...
        function Hg(a) {
            this.va = new Ig(a);
            this.g = a.g;
            x(a.oa, "Only valid if limit has been set");
            this.ea = a.ea;
            this.Gb = !wi(a)
        }
        h = Hg.prototype;
        h.K = function (a, b, c, d, e) {
            this.va.matches(new N(b, c)) || (c = Q);
        ...
        h.xa = function (a, b, c) {
            ...
            if (b.R() || b.f()) d = Q.pb(this.g);
                ...
                for (var e = 0, B = !1; 0 < b.Ta.length;) f = S(b), !B && 0 >= m(k, f) && (B = !0), (g = B && e < this.ea && 0 >= m(f, l)) ? e++ : d = d.T(f.name, Q)
            }
        ...
        function xi(a, b, c, d, e, f) {
            ...
            if (b.Ma(c)) {
                var B = b.P(c),
                    m = e.de(a.g, m, a.Gb);
                null != m && m.name == c && (m = e.de(a.g, m, a.Gb));
                e = null == m ? 1 : g(m, l);
                if (P && !d.f() && 0 <= e) return null != f && ri(f, new V("child_changed", d, c, B)), b.T(c, d);
                null != f && ri(f, new V("child_removed", B, c));
                b = b.T(c, Q);
                return null != m && a.va.matches(m) ? (null != f && ri(f, new V("child_added", m.node, m.name)), b.T(m.name,
                    m.node)) : b
            }
            return d.f() ? b : P && 0 <= g(m, l) ? (null != f && (ri(f, new V("child_removed", m.node, m.name)), ri(f, new V("child_added", d, c))), b.T(c, d).T(m.name, Q)) : b
        };
        ...
        function ri(a, b) {
            var c = b.type,
                d = b.$a;
            x("child_added" == c || "child_changed" == c || "child_removed" == c, "Only child changes supported for tracking");
            x(".priority" !== d, "Only non-priority child changes can be tracked.");
            var e = t(a.kb, d);
            if (e) {
                var f = e.type;
                ...
                else if ("child_removed" == c && "child_changed" == f) a.kb[d] = new V("child_removed", e.pe, d);
                else if ("child_changed" == c &&
                    "child_added" == f) a.kb[d] = new V("child_added", b.Oa, d);
                else if ("child_changed" == c && "child_changed" == f) a.kb[d] = new V("child_changed", b.Oa, d, e.pe);
                else throw Ib("Illegal combination of changes: " + b + " occurred after " + e);
            } else a.kb[d] = b
        };
        ...
        function ti(a) {
            x(a.pa, "Only valid if start has been set");
            return a.dc
        }
        ...
        function vi(a) {
            x(a.ra, "Only valid if end has been set");
            return a.ac
        }
        ...
        function vf(a) {
            ...
            var c;
            a.g === R ? c = "$priority" : a.g === fe ? c = "$value" : a.g === ce ? c = "$key" : (x(a.g instanceof Yd, "Unrecognized index type!"), c = a.g.toString());
            b.orderBy = u(c);
        ...
        function Ci(a) {
            ...
            } else if (x(a.g instanceof Yd || a.g === fe, "unknown index type."), null != b && "object" === typeof b || null != c && "object" === typeof c) throw Error("Query: First argument passed to startAt(), endAt(), or equalTo() cannot be an object.");
        }
        ...
        Z.prototype.fc = function (a, b, c) {
            ...
            e = this.D;
            d = ".info" === J(this.path) ? e.md.nb(this, d) : e.S.nb(this, d);
            Ph(e.ha, this.path, d)
        };
        Z.prototype.off = Z.prototype.fc;
        Z.prototype.ef = function (a, b) {
            function c(k) {
                f && (f = !1, e.fc(a, c), b && b.call(d.context, k), g.resolve(k))
            }
        ...
        Z.prototype.limit = Z.prototype.ne;
        Z.prototype.od = function (a) {
            ...
            return new Z(this.D, this.path, this.B.od(a), this.ic)
        };
        Z.prototype.limitToFirst = Z.prototype.od;
        Z.prototype.limitToFirst = Z.prototype.od;
        ...
        Z.prototype.limitToLast = Z.prototype.pd;
        Z.prototype.limitToLast = Z.prototype.pd;
        ...
        function Fi(a, b, c) {
            ...
            if (b && c) d.cancel = b, G(a, 3, d.cancel, !0), d.context = c, ud(a, 4, d.context);
            else if (b)
                if ("object" === typeof b && null !== b) d.context = b;
                else if ("function" === typeof b) d.cancel = b;
            else throw Error(td(a, 3, !0) + " must either be a cancel callback or a context object.");
            return d
        };
        ...
        function W(a, b, c) {
            ...
            if (!b && !c) {
                ...
                a = La(b);
                c = a.Jg;
                "wilddog" === a.domain && Qb(a.host + " is no longer supported. Please use <YOUR WILDDOG>.wilddogio.com instead");
                c || Qb("Cannot parse Wilddog url. Please use https://<YOUR WILDDOG>.wilddogio.com");
                a.Hb || "undefined" !== typeof window && window.location && window.location.protocol && -1 !== window.location.protocol.indexOf("https:") && y("Insecure Wilddog access from a secure page. Please use https.");
                if (a.Db) {
                    var d = a.Db;
                    d && (d = d.replace(/^\/*\.info(\/|$)/, "/"));
                    q(d) && 0 !== d.length && !Dd.test(d) || Qb("App syncURL was an invalid path: " + b + '. Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"')
                }
        ...
        W.prototype.name = function () {
            y("Wilddog.name() being deprecated. Please use Wilddog.key() instead.");
        ...
        W.prototype.key = function () {
            ...
            return this.path.f() ? null : xd(this.path)
        };
        ...
        W.prototype.set = function (a, b) {
            ...
            G("Wilddog.set", 2, b, !0);
            var c = new C;
            this.D.ob(this.path, a, null, D(c, b));
            return c.o
        };
        ...
        W.prototype.update = function (a, b) {
            ...
            if (ea(a)) {
                for (var c = {}, d = 0; d < a.length; ++d) c["" + d] = a[d];
                a = c;
                y("Passing an Array to Wilddog.update() is deprecated. Use set() if you want to overwrite the existing data, or an Object with integer keys if you really do want to only update some of the children.")
            }
            Kd("Wilddog.update", a, this.path);
            G("Wilddog.update", 2, b, !0);
            c = new C;
            this.D.update(this.path, a, D(c, b));
            return c.o
        };
        ...
        W.prototype.transaction = function (a, b, c) {
            ...
            if (p(c) && "boolean" != typeof c) throw Error(td("Wilddog.transaction", 3, !0) + "must be a boolean.");
        ...
        W.prototype.xg = function (a, b) {
            ...
            var c = new C;
            this.D.ob(this.path.u(".priority"), a, null, D(c, b));
            return c.o
        };
        ...
        W.prototype.Me = function (a, b) {
            ...
            !0 === a ? ("undefined" !== typeof console && ("function" === typeof console.log ? Mb = r(console.log, console) : "object" === typeof console.log && (Mb = function (a) {
                console.log(a)
            })), b && v.set("logging_enabled", !0)) : a ? Mb = a : (Mb = null, v.remove("logging_enabled"))
        };
        ...
        Ya && Ya.lf && Ya.lf(Z);
        Sd.te("sync", function (a) {
            if (null == a) throw Error("application not initialized!Please call wilddog.initializeApp first");
            return new W(a)
        });
        Sd.te("auth", function (a) {
            if (null == a) throw Error("application not initialized!Please call wilddog.initializeApp first");
            null == a.Fe && (a.Fe = new M(a));
            return a.Fe
        });
        (function (a) {
            ...
            [{
                ...
                b.name ? (a.auth.WilddogAuthProvider.emailCredential = function (a, d) {
                    ...
                    y("wilddog.auth.EmailAuthProvider being deprecated. Please usewilddog.auth.WilddogAuthProvider instead.");
                    var c = {};
                    c.provider = b.id;
                    c[b.rb] = a;
                    c[b.Ya] = d;
        ...
        if ("WEB" == CLIENT_TYPE) "object" == typeof module && module.exports && (module.exports = Sd), "function" == typeof define && define.amd && define("wilddog", [], function () {
            return Sd
        }), window ? window.wilddog = Sd : WorkerGlobalScope && self && (self.wilddog = Sd);
